		...
		<footer id="footer">
			...
			<div class="container">
				...
				<div id="footer-social">
					...
					<?php if(get_theme_mod('laurel_snapchat')) : ?><a href="http://snapchat.com/add/<?php echo esc_html(get_theme_mod('laurel_snapchat')); ?>" target="_blank"><i class="fa fa-snapchat-ghost"></i> <span><?php esc_html_e( 'Snapchat', 'laurel' ); ?></span></a><?php endif; ?>
